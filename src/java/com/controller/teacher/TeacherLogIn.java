...
//        processRequest(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            t = TeacherLogInDAO.getInstance().logIn(user, pass);
            if (t.getName() != null) {
                session.setAttribute("t", t);
                request.getRequestDispatcher("manageForTeacher.jsp").forward(request, response);
            } else {
                String error = "Invalid username or password";
                request.setAttribute("error", error);
                request.getRequestDispatcher("logInForTeacher.jsp").forward(request, response);
            }
